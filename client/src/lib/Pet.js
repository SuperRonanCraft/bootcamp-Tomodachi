...
export const POSSIBILITIES = {
  ...
  play: {
    food: [-1, -2, -3], //[-1, -2, -3],
    happiness: [2, 2, 3, 4], //[3, 4, 5, 6],
    energy: [-1, -2, -3], //[-1, -2, -3],
  },
  feed: {
    food: [2, 2, 3, 4], //[2, 3, 4, 5],
    happiness: [1, 2, 0, 0], //[1, 2, 3, 4],
    energy: [-1, -1, -2, -3], //[-2, -3, -4],
  },
  sleep: {
    food: [-2, -3, -3, -3, -4], //[-2, -3, -4],
    happiness: [-2, -1, -1, 0], //[-1, 0, 1],
    energy: [3, 3, 3, 4, 5], //[3, 4, 5],
  },
};
